...
Answer:
1. Ensure that the columns used in the WHERE clause and JOIN conditions are indexed appropriately. Indexing can significantly speed up the retrieval process.
2. reduce the OR and LIKE by avoiding unnecessary search.
3. If can be confirmed, remove the unnecessary wildcard at the beginning of the LIKE statement.